    ...
    <div style="width: 100%; max-width: 600px; padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); box-sizing: border-box; text-align: center;">
        ...
        <div class="info-box" id="info-box" style="padding: 20px; border: 1px solid #ccc; border-radius: 8px; margin-top: 20px;">
            ...
            <div class="content-div">
                ...
                <p>An email has been sent to: <strong>${admin.email}</strong></p>
                <br>
                <a href="${pageContext.request.contextPath}/AdminLogin" style="text-decoration: none; background-color: #4CAF50; color: white; padding: 10px 20px; border-radius: 4px; display: inline-block; margin-top: 20px;">Go to Admin Login Page</a>
            </div>
        </div>
    </div>
</body>
